...
Helm:: no upgrades, don't handle API changes
...
It's unreasonable to think that every customer will be ready to reconfigure the application in a coordinated maintenance window to reduce downtime as much as possible.
