...
func (in *BackupConfigSpec) DeepCopyInto(out *BackupConfigSpec) {
	*out = *in
	...
	if in.MinioProvider != nil {
		in, out := &in.MinioProvider, &out.MinioProvider
		*out = new(MinioProviderSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MinioProviderSpec) DeepCopyInto(out *MinioProviderSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MinioProviderSpec.
func (in *MinioProviderSpec) DeepCopy() *MinioProviderSpec {
	if in == nil {
		return nil
	}
	out := new(MinioProviderSpec)
